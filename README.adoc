...
SpielID ist immer ProduktID




1. ist 0 ohne eingabe -> Integer groß
2. unbewertete spiele zu erst -> bei Top nur bewertete Spiele ausgeben
3. wie soll die ausgabe aussehen bei mehreren zusatzinhalten -> zusatzinhalte mit whileschleife in eine ausgabe basteln
